...
Episode: 40 steps x 36 min/step = 24 hours simulated time (condensed, step_scale=7.2).
...
def build_hard_scenario(seed: int = 0) -> FacilityState:
    ...
    zone_ai_1 = ZoneState(
        ...
        it_load_pct=0.90,
        thermal_mass_kj_per_k=944.0,   # 500/450 x 850
    )
    ...
    zone_ai_2 = ZoneState(
        ...
        it_load_pct=0.90,
        thermal_mass_kj_per_k=907.0,   # 480/450 x 850
    )
    ...
    zone_infra = ZoneState(
        ...
        it_load_pct=0.90,
        thermal_mass_kj_per_k=227.0,   # 120/450 x 850
    )
